			...
			<td class="control">
				<table class="control">
					<tr>
						...
						<s:form action="categorizacionPorFecha">
							<td><s:label value="Fecha Inicio" /></td>
							<td><sj:datepicker name="fecIni" displayFormat="dd/mm/yy" required="true" value="today" />
							</td>
							<td><s:label value="Fecha Fin" /></td>
							<td><sj:datepicker name="fecFin" displayFormat="dd/mm/yy" required="true"  value="today"  />
							</td>
							<td><s:label value="Estado" /></td>

							<td><s:select
									list="#{'APROBADO':'APROBADO','RECHAZADO':'RECHAZADO'}"
									name="estadoCate"></s:select></td>
							<td><s:submit action="categorizacionPorFecha"></s:submit></td>
						</s:form>
					</tr>
					...
					<tr>
						...
						<th width="150" align="center"><s:text name="Monto Entrega" />
						</th>
						<th width="150" align="center"><s:text
								name="Nomb. Trabajador" />
						</th>
